    ...
    <View style={styles.container}>
      <View style={styles.sliderContainer}>
        <View style={styles.imageContainer}>
          <Image
            source={ImagePicker.bestDealsImage}
            style={styles.image}
            resizeMode="contain"
          />
          ...
          <View style={styles.sliderContent}>
            <View style={styles.headContent}>
              <Text style={styles.sliderText}>
                <Text style={styles.bold}>{commonEntities.bestDealsTitle}</Text>
              </Text>
            </View>
            <Text style={styles.seventyPercentOffStyle}>
              {commonEntities.salesOftheMonth}
            </Text>
            <View style={styles.descriptionContent}>
              <Text style={styles.sliderDescription}>
                {commonEntities.saleEnded}
              </Text>
            </View>
...
export default BestDealsSalesMonth;
